...
import {  Button, TextField, Dialog, DialogActions, DialogContent, DialogTitle, Grid, Typography } from '@material-ui/core';
  ...
  return (
      <>
        ...
        <SearchContextManager apiKey={"sXpGFDGZs0Dv1mmNFvYaGUvYwKX0PWIh"}>
            <GiphyModal open={giphyModal} close={() => setGiphyModal(false)} setImage={setImageField} />
